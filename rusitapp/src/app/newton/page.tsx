      ...
      {rows.length > 0 && (
        <div className="rounded-2xl border border-slate-200/60 bg-white/80 backdrop-blur-md shadow-lg shadow-slate-200/60 overflow-x-auto p-0">
          <table className="w-full text-sm">
            <thead className="sticky top-0 bg-gradient-to-r from-slate-50 to-slate-100">
              <tr>
                ...
                <th className="p-2 text-left font-semibold text-slate-600">f(xi)</th>
                <th className="p-2 text-left font-semibold text-slate-600">f'(xi)</th>
                <th className="p-2 text-left font-semibold text-slate-600">xi+1</th>
            ...
            <tbody>
              {rows.map((r) => (
                <tr key={r.i} className="odd:bg-white/80 even:bg-slate-50/70 hover:bg-white transition-colors">
                  ...
                  <td className="p-2 border-t border-slate-200/70 font-mono align-middle">{fmt(r.fxi)}</td>
                  <td className="p-2 border-t border-slate-200/70 font-mono align-middle">{fmt(r.dfxi)}</td>
                  <td className="p-2 border-t border-slate-200/70 font-mono align-middle">{fmt(r.xi1)}</td>
